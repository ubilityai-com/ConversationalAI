...
def create_service(access_token, API_SERVICE_NAME="sheets", API_VERSION="v4"):
    """
...
def create_token(cred):
    try:
        ...
        result['scopes']=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/drive"]
...
def googleSheet_create_spreadsheet(json_cred, params, **kwargs):
    """
...
def googleSheet_delete_spreadsheet(json_cred, params, **kwargs):
    ...
    try:
        ...
        if "spreadsheetId" in params:
            ...
            drive_service = create_service(access_token,"drive","v3")
...
def googleSheet_create_sheet(json_cred, params, **kwargs):
    """
...
operations = {
    'CREATE_SPREADSHEET':googleSheet_create_spreadsheet,
    'DELETE_SPREADSHEET':googleSheet_delete_spreadsheet,
    'CREATE_SHEET':googleSheet_create_sheet,
    'UPDATE_ROWS':googleSheet_update_rows_in_sheet,
    'DELETE_COLS_OR_ROWS':googleSheet_delete_ColOrRow_from_sheet,
    'REMOVE_SHEET':googleSheet_remove_sheet,
    'READ_ROWS':googleSheet_read_rows_in_sheet,
    'APPEND_DATA':googleSheet_append_data_to_sheet,
    'CLEAR_DATA':googleSheet_clear_data_from_sheet
}