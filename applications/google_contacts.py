...
def create_service(ACCESS_TOKEN, API_SERVICE_NAME="people", API_VERSION="v1"):
    """
...
def Google_Contacts_get_all_contacts(json_cred, params, **kwargs):
    """
    ...
    try:
        ...
        if "personFields" in params:
            ...
            service = create_service(ACCESS_TOKEN, API_SERVICE_NAME="people", API_VERSION="v1")
...
def Google_Contacts_get_contact(json_cred, params, **kwargs):
    """
    ...
    :return: Person resource object representing the retrieved contact. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/people>`_
    :rtype: dict
    """
    try:
        cred=json.loads(json_cred)
...
def Google_Contacts_search_contacts(json_cred, params, **kwargs):
    """
...
def Google_Contacts_create_contact(json_cred, params, **kwargs):
    """
    ...
    - :body: (dict, Required) - an instance of the Person object which contains Information about a person merged from various data sources such as the authenticated user's contacts and profile data. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/people>`_

    :return: Person resource object of the newly created Contact. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/people>`_
    :rtype: dict
    """
    try:
        cred=json.loads(json_cred)
...
def Google_Contacts_update_contact(json_cred, params, **kwargs):
    """
    ...
    :return: Person resource object of the newly Updated Contact. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/people>`_
    :rtype: dict
    """
    try:
        cred=json.loads(json_cred)
...
def Google_Contacts_delete_contact(json_cred, params, **kwargs):
    """
...
def Google_Contacts_upload_contact_photo(json_cred, params, **kwargs):
    """
    ...
    :return: Person resource object representing the contact the photo was uploaded to. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/people>`_
    :rtype: dict
    """
    try:
        cred=json.loads(json_cred)
...
def Google_Contacts_get_all_groups(json_cred, params, **kwargs):
    """
...
def Google_Contacts_create_group(json_cred, params, **kwargs):
    """
    ...
    :return: ContactGroup resource object of the newly created Contact Group. for more information see this `LINK <https://developers.google.com/people/api/rest/v1/contactGroups>`_
    :rtype: dict
    """
    try:
        cred=json.loads(json_cred)
...
def Google_Contacts_update_contacts_in_group(json_cred, params, **kwargs):
    """
...
operations = {
    'Get All Contacts':Google_Contacts_get_all_contacts,
    ...
    'Update Contact':Google_Contacts_update_contact,
    'Delete Contact':Google_Contacts_delete_contact,
    'Upload Contact Photo':Google_Contacts_upload_contact_photo,
    'Get All Contact Groups':Google_Contacts_get_all_groups,
    'Create Group':Google_Contacts_create_group,
    'Update Contacts In Group':Google_Contacts_update_contacts_in_group
}