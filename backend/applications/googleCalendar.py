...
def Google_Calendar_get_all_events(creds, params,**kwargs):
    """
...
def Google_Calendar_create_event(creds, params,**kwargs):
    """
    ...
    try:
        ...
        if "start" in params and "end" in params and "calendarId" in params:
            ...
            response = (
                service.events()
                .insert(calendarId=params["calendarId"], body=to_create)
                .execute()
            )
            return response
        else:
...
def Google_Calendar_get_event(creds, params,**kwargs):
    """
    ...
    try:
        ...
        if "calendarId" in params and "eventId" in params:
            ...
            response = (
                service.events()
                .get(calendarId=params["calendarId"], eventId=params["eventId"])
                .execute()
            )
            return response
        else:
...
def Google_Calendar_delete_event(creds, params,**kwargs):
    """
    ...
    try:
        ...
        if "calendarId" in params and "eventId" in params:
            ...
            response = (
                service.events()
                .delete(calendarId=params["calendarId"], eventId=params["eventId"])
                .execute()
            )
            return {"Result" : f"Event with ID : {params['eventId']} deleted successfully "}
        else:
            raise Exception("missing input data")
    except Exception as error:
        return {"Error": str(error)}
...
def Google_Calendar_update_event(creds, params,**kwargs):
    """
...
def Google_Calendar_get_calendar(creds, params,**kwargs):
    """
    ...
    try:
        ...
        if "calendarId" in params:
            service = create_service(ACCESS_TOKEN)
            response = (
                service.calendars().get(calendarId=params["calendarId"]).execute()
            )
            return response
        else:
...
operations = {
    ...
    'Get Event':Google_Calendar_get_event,
    'Update Event':Google_Calendar_update_event,
    'Delete Event':Google_Calendar_delete_event,
    'Get All Events':Google_Calendar_get_all_events,
    'Get Calendar':Google_Calendar_get_calendar,
}
