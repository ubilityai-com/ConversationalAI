...
export type ValidationConditionFunction = (value: string, requiredWords?: string[]) => string | null

// Transform function types
export type TransformFunction = (item: AutomationItem, flowZoneSelectedID?: string, store?: any) => Record<string, any>
...
export const isTextFieldItem = (item: AutomationItem): item is TextFieldItem => item.type === "textfield"
export const isDropdownItem = (item: AutomationItem): item is DropdownItem => item.type === "dropdown"
export const isApiItem = (item: AutomationItem): item is ApiItem => item.type === "api"
export const isCheckboxItem = (item: AutomationItem): item is CheckboxItem => item.type === "checkbox"
export const isRadioButtonItem = (item: AutomationItem): item is RadioButtonItem => item.type === "radiobutton"
export const isMultiSelectItem = (item: AutomationItem): item is MultiSelectItem => item.type === "multiselect"
export const isColorItem = (item: AutomationItem): item is ColorItem => item.type === "color"
export const isFileItem = (item: AutomationItem): item is FileItem => item.type === "file"
export const isTextFormatterItem = (item: AutomationItem): item is TextFormatterItem => item.type === "textFormatter"
export const isEditorItem = (item: AutomationItem): item is EditorItem => item.type === "editor"
export const isArrayItem = (item: AutomationItem): item is ArrayItem => item.type === "array"
export const isJsonItem = (item: AutomationItem): item is JsonItem => item.type === "json"
export const isDynamicItem = (item: AutomationItem): item is DynamicItem => item.type === "dynamic"
export const isAccordionItem = (item: AutomationItem): item is AccordionItem => item.type === "accordion"
export const isRowItem = (item: AutomationItem): item is RowItem => item.type === "row"
export const isOutputJsonItem = (item: AutomationItem): item is OutputJsonItem => item.type === "outputJson"


export interface NodeConfigProps extends Record<string, any> {
  label: string;
  description: string;
  rightSideData: Record<string, any>;
}
export interface NodeFormProps {
  selectedNode: NodeProps<Node<NodeConfigProps>>;
