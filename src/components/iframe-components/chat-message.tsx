...
export function ChatMessage({ message }: ChatMessageProps) {
  ...
  const renderFilePreview = (fileName: string, isImage: boolean, url?: string) => {
    if (isImage) {
      return <img src={url} alt={fileName} className="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded" />;
    }
    return (
          ...
          >
            <div className="flex items-center">
              <div
                ...
                className="prose prose-sm sm:prose-base leading-relaxed max-w-none whitespace-pre-wrap"
        ...
        {Array.isArray(message.attachments) && message.attachments.length > 0 && (
          <div className="space-y-2">
            {message.attachments.map((attachment: any) => {
              ...
              const isImage = attachment.file?.type
              ...
              return (
                ...
                >
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      handleDownload({ url: attachment.url, name: fileName })
                    }
