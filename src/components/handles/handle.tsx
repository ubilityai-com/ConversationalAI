...
export function NodeHandle({
  ...
  const setFormDialogStatus = useFlowStore(
    (state) => state.setFormDialogStatus
  );
    ...
    switch (variant) {
      case "input":
        return {
          ...
          ...(isConnected && {
            boxShadow:
              "0 0 0 2px rgba(52, 211, 153, 0.3), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
          }),
        };
      case "output":
        return {
          ...
          ...(isConnected && {
            boxShadow:
              "0 0 0 2px rgba(96, 165, 250, 0.3), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
          }),
        };
      case "condition":
        return {
          ...
          ...(isConnected && {
            boxShadow:
              "0 0 0 2px rgba(251, 191, 36, 0.3), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
          }),
        };
      case "choice":
        return {
      ...
      default:
        return {
          ...
          ...(isConnected && {
            boxShadow:
              "0 0 0 2px rgba(156, 163, 175, 0.3), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
          }),
        };
    }
  };
  ...
  return (
    <>
      {props.type === "source" && !hasOutgoingConnection && (
        <div
          className="absolute top-1/2 transform -translate-y-1/2 flex items-center justify-start"
